    ...
    return (
        <div className="flex h-screen w-full overflow-hidden transition-colors duration-300">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden z-10 p-4">
                ...
                <header className="flex items-center justify-between px-6 lg:px-8 shrink-0 z-20 transition-all duration-300">
                    ...
                    <div className="flex items-center gap-3 bg-[#F3E8FD] dark:bg-blue-500/20 rounded-full px-3">
                        ...
                        <div className="relative" ref={profileRef}>
                            ...
                            <div 
                                className={`absolute right-0 mt-3 w-56 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl transition-all duration-200 origin-top-right z-50 ${
